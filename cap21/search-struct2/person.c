...
void print_persons(PERSON *arr, int size)
{
...
int compare_person_firstName(const void* ptr1, const void* ptr2)
{
  return strcmp(((PERSON *) ptr1)->firstName, ((PERSON *) ptr2)->firstName);
}
