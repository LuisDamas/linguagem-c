...
{
  if (n<=1) return;           // 1 elemento está sempre ordenado

  insertion_sort_int(v, n-1); // Ordenar a sublista da esquerda

  int j, last = v[n-1];       // Posicionar o último elemento do array
